...
const projects = [
  {
    ...
    description:
      "<p>A Photo rich responsive website built using intesive JavaScript. Implementation of various breakpoints by using javascript enabled portability of the website.</p>",
    websiteLink: "https://ashutoshverma23.github.io/photography/index.html",
    // techno
    html: true,
    css: true,
    javascript: true,
  ...
  {
    id: 2,
    image: images.hindlionss,
    heading: "Hind Lionss Security Service",
    description:
      "<Also>One of my first freelance project.<p/> <br/> <p>I had some fun working with this project with my flatmate. Also improved a lot with Github and Hosting services for delivering this project.</p>",
    websiteLink: "https://hindlionss.in",
    html: true,
    javascript: true,
    tailwind: true,
    react: true,
  ...
  {
    id: 3,
    image: images.rickshaw,
    heading: "RickShaw an automation application for rickshaw finding",
    description:
      "<p>Created an application using MERN stack to connect Rikshaw drivers and Passengers through real-time GPS location service. Optimized API calls to handle real-time data dynamically. </p>",
    websiteLink: "https://rickshaw.vercel.app/",
    // techno
    html: true,
    react: true,
    express: true,
