    ...
    >
      ...
      >
        ...
        <ul className="text-base text-primary-400 list-inside list-disc dark:text-neutral-200">
          <li>
            Developed responsive web application using JavaScript, React,
            Tailwind.
          </li>
          <li>
            Created and developed websites, landing pages, contact forms,
            application forms that could be suitable for both job provider and
            applier for different devices
          </li>
          <li>
